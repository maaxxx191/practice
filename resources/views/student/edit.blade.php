                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6 d-flex align-items-center">{{ $array['id'] }}</div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $array['name'] }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ $array['address'] }}" required autocomplete="address">
                        ...
                        <div class="form-group">
                          ...
                          <textarea id="textarea" class="form-control">{{ $array['comment'] }}</textarea>
                        </div>
